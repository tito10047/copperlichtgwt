...
public class MetaTriangleSelector extends JavaScriptObject implements TriangleSelectorInt {

	protected MetaTriangleSelector() {
	}
	/**
	...
	/**
	 * Interface for making multiple triangle selectors work as one big
	 * selector.
	 */

	public static native MetaTriangleSelector create() /*-{
		return new $wnd.CL3D.MetaTriangleSelector();
	}-*/;
	 ...
	 * 
	 * @param t
	 *            a TriangleSelector to add
	 */
	public final native JavaScriptObject addSelector(TriangleSelector t) /*-{
		return this.addSelector(t);
	}-*/;
