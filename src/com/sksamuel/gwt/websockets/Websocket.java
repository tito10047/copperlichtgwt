...
public class Websocket {
	...
	private native void _open(Websocket ws, String s, String url) /*-{
		...
		$wnd.s.onopen = function() {
			ws.@com.sksamuel.gwt.websockets.Websocket::onOpen()();
		};
		$wnd.s.onclose = function() {
			ws.@com.sksamuel.gwt.websockets.Websocket::onClose()();
		};
		$wnd.s.onerror = function() {
			ws.@com.sksamuel.gwt.websockets.Websocket::onError()();
		};
