...
public class MeshTriangleSelector extends JavaScriptObject implements TriangleSelectorInt {

	protected MeshTriangleSelector() {
	}
	...
	public static native MeshTriangleSelector create(Mesh Mesh, SceneNode scenenode) /*-{
		return new $wnd.CL3D.MeshTriangleSelector(Mesh, scenenode);
	}-*/;
